 ...
 * @param fileName the file name that we will use for the vehicle list
 */
 ...
 * @param vehicles the VehicleList object that will be saved
 */
	...
	/**
	 * a method for adding a vehicle to the vehicle list and after saving the list
	 * @param vehicle the vehicle that will be added to the list
	 */
	...
	/**
	 * a method for deleting a vehicle from the list that matches the reg number received as a parameter
	 * @param regNo the registration number of the vehicle that will be deleted from the list
	 */
	 ...
	 * @param vehicle the vehicle that will have its price changed
	 * @param price the price that will become the new rental price of the vehicle given as a parameter
	 */
