...
public class LoadInitialData
{
   ...
   public static void main(String[] args)
   {
      ...
      {  
         ...
         autoCamperArray = mtfio.readArrayFromFile("autoCampers.txt");
         vanArray = mtfio.readArrayFromFile("vans.txt");
         familyCarArray = mtfio.readArrayFromFile("familyCars.txt");
         movingTruckArray = mtfio.readArrayFromFile("movingTrucks.txt");
