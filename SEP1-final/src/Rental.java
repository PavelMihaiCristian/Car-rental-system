...
public class Rental implements Serializable
{
    ...
    */
   public Rental(Vehicle vehicle,Customer customer,Date pickUpTime,Date returnTime,String pickUpLocation,String returnLocation)
   {
    ...
    * @param estimatedKm the number of kilometers that the client will do with the car
    */
   public double calculateRentalPrice(double estimatedKm)
   {
      double sum=0;
      if(rentalPeriod()<=2){
