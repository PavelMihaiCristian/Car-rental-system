...
public class VehicleList implements Serializable {
	 ...
	 * @param regNo the registration number it is looked for 
	 ...
	 * @param index the index from where we want to get the vehicle from
	...
	/**
	 * a method for adding a vehicle to the vehicle list
	 * @param vehicle the vehicle that will be added to the vehicle list
	 */
	public void addVehicle(Vehicle vehicle){
		vehicles.add(vehicle);
	}
	/**
	 * a method for removing a vehicle from the vehicle list
	 * @param regNo the registration number of the car that will be removed from the list
	 */
